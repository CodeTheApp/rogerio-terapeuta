      ...
      <div className="max-w-screen-2xl mx-auto grid md:grid-cols-2 gap-20 items-center">
        ...
        >
          <img 
            ...
            alt="Consultório" 
            className="rounded-[2.5rem] w-full aspect-square object-cover grayscale-[20%] hover:grayscale-0 transition-all duration-700"
          ...
          <div className="absolute -top-6 -right-6 bg-surface-container-lowest p-8 rounded-2xl shadow-xl hidden md:block border border-primary/5">
            <p className="font-headline text-3xl text-primary font-bold">15+</p>
            <p className="text-xs uppercase tracking-widest text-on-surface-variant font-semibold">Anos de Prática</p>
          </div>
        </motion.div>
        ...
        >
          <span className="text-secondary font-bold uppercase tracking-[0.2em] text-sm mb-6 block">Sobre Mim</span>
          <h2 className="text-4xl md:text-5xl font-headline mb-8 text-on-surface leading-tight">Um olhar atento às profundezas da alma</h2>
